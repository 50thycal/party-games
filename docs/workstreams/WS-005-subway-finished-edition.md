...
OWNER DECISION — G2/G3: how a peg space is measured. The code uses straight-line distance (one
diagonal step ≈ 1.41) with ±0.5 tolerance; approved §2 reads as though a diagonal step
is exactly one space. G9 and G15 (approved-text touch-ups) wait on the same edit.
Review State: PR #200 — awaiting independent review of its current head.
Next Step: Owner rules on G2/G3; independent review of PR #200.
