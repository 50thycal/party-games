...
Status: Active
Updated: 2026-09-25
Implementation State: Rules audit fixes merged by PR #200 (current-company iPad cards, exact-only lengths, text fixes, drift test). Follow-up peg-space wording PR on branch claude/game-mechanics-audit-83ieqx: approved rulebook §1–3 corrected per the owner's tight-string ruling; no mechanics change. Build, lint and full Subway suite pass.
Related PRs: Peg-space follow-up PR (open); [#200](https://github.com/50thycal/party-games/pull/200) (rules audit, merged); [#198](https://github.com/50thycal/party-games/pull/198) (merged intro); [#197](https://github.com/50thycal/party-games/pull/197) (paid extensions); [#196](https://github.com/50thycal/party-games/pull/196) (merged verification); [#195](https://github.com/50thycal/party-games/pull/195) (second YMIF economy/card bundle); [#194](https://github.com/50thycal/party-games/pull/194) (YMIF bundle); [#188](https://github.com/50thycal/party-games/pull/188) (terminology audit); [#187](https://github.com/50thycal/party-games/pull/187) (optional bend modes); [#186](https://github.com/50thycal/party-games/pull/186) (draft rules/highlights); [#185](https://github.com/50thycal/party-games/pull/185) (public status/payments/draft); [#184](https://github.com/50thycal/party-games/pull/184) (JNCG cards/surveys/labels); [#177](https://github.com/50thycal/party-games/pull/177) (PRWK feedback); [#176](https://github.com/50thycal/party-games/pull/176) (phone joining; merged); [#175](https://github.com/50thycal/party-games/pull/175) (Playtest Lab); [#174](https://github.com/50thycal/party-games/pull/174) (transfer/objective continuation); [#173](https://github.com/50thycal/party-games/pull/173) (larger neighborhoods/reversed VP; merged); [#172](https://github.com/50thycal/party-games/pull/172) (guided turns, neighborhoods and tiers; merged); [#171](https://github.com/50thycal/party-games/pull/171) (completion cash and companions; merged); [#170](https://github.com/50thycal/party-games/pull/170) (network objectives/economy and Construction removal; merged); [#169](https://github.com/50thycal/party-games/pull/169) (Plan-panel viewport; merged); [#168](https://github.com/50thycal/party-games/pull/168) (saved-plan opt-in; merged); [#167](https://github.com/50thycal/party-games/pull/167) (Undo/pan; merged); [#166](https://github.com/50thycal/party-games/pull/166) (tap-and-plan; merged); [#165](https://github.com/50thycal/party-games/pull/165) (build-cost preview; merged); [#164](https://github.com/50thycal/party-games/pull/164) (active-route guidance; merged); [#163](https://github.com/50thycal/party-games/pull/163) (direct-piece mobile fixes; merged); [#162](https://github.com/50thycal/party-games/pull/162) (saved planning; merged); [#161](https://github.com/50thycal/party-games/pull/161) (merged); [#160](https://github.com/50thycal/party-games/pull/160) (touch tabletop correction; merged); [#159](https://github.com/50thycal/party-games/pull/159) (mobile tabletop; merged); [#154](https://github.com/50thycal/party-games/pull/154), [#155](https://github.com/50thycal/party-games/pull/155), [#156](https://github.com/50thycal/party-games/pull/156), [#157](https://github.com/50thycal/party-games/pull/157) (merged); [#158](https://github.com/50thycal/party-games/pull/158) (construction clarity and playtest export)

## Current continuation — rules-vs-code audit

Owner asked for an audit of where the rules, tutorial and intro disagree with the coded
mechanics, and a decision on each gap. Register: [rules audit](../subway-rules-audit.md).

Goal: every player-facing surface states what the reducer does, and a test keeps it so.
Non-goals: rebalancing, new mechanics, the knob consolidation (K2/K3, parked), a new
tutorial lesson for extensions, and any edit to owner-approved rulebook §1–3 without a ruling.
Owner rulings (2026-09-25): the iPad shows only the current company's cards; exact
segment lengths only, bends remain; scope is docs + drift test + separate Engineering price.
DEC-063 records both rule changes.
Acceptance: G1, G4–G8, G10–G12, G14, K1 and K4 fixed; `scripts/subway-docs-test.ts`
runs in `test-subway.sh`; build, lint and full Subway suite pass.
Owner ruling (G2/G3, 2026-09-25): a segment's length is a tight physical string stretched
straight from peg to peg, which is the straight-line measurement the code already uses.
Approved §2 is reworded to match (holes are locations, pegs are stations, a diagonal step ≈ 1.4
spaces); §1 fragment and §3 pair/triple wording fixed in the same PR.
Review State: PR #200 merged by the owner before an independent review or finalization commit; this
checkpoint records that. Peg-space follow-up PR: awaiting independent review.
Next Step: Independent review of the peg-space follow-up PR.

## Previous continuation — paid extensions; configurable draft parked
...
Review State: PR #198 — Approved by /root/intro_review for source head
26ca72b58aa5cca756f618e2cec5f221c513d80a. Implementation actor: /root.
Verdict: https://github.com/50thycal/party-games/pull/198#issuecomment-5747119855.
No Blocking or Should-fix findings remain. Finalization: pushed (documentation
only); reviewer verification of the resulting head is recorded on PR #198.
Prior PR verdicts below preserved.
PR #197 remains separate extension work; configurable line counts are parked.
Next Step: None for the completed intro mission. Paid extensions continue separately
in #197; this PR does not claim their implementation or merge.
...
Goal: exercise both merged bundles in the public game, correct confirmed defects,
and leave reproducible regression coverage and honest acceptance evidence.
Non-goals: balance changes, deferred tutorial/endgame/extra-line decisions, physical-device claims.
Acceptance: browser phone portrait and shared-board draft/purchase/construction flows;
all approved bundle rules covered by focused and complete 2/3/4-player simulations;
production build, lint and full Subway suite; one independently reviewed PR.
Evidence: [combined verification report](../testing/YMIF-playtest-verification.md).
Public four-company room WZQC completed, with interactive phone/tablet drafting,
purchases and delayed construction followed by bot completion. Desktop shared board,
390×844 portrait phone and landscape guidance exercised; not physical-device testing.
No product changes were necessary. Expanded complete 2/3/4-company companion games
buy both extras for every company using post-draft cash, and compare 72 projected
recaps (43 with income) against authoritative state. Build/lint/full Subway suite pass.
Review State: PR #196 — Approved with follow-ups by /root/bundle_review for published
source head 21ae5e9a6b6b13dcaa8c1dc3ba122e8b6f9a2f17. Implementation actor: /root.
Verdict: https://github.com/50thycal/party-games/pull/196#issuecomment-5745706954.
No Blocking or Should-fix findings. Reviewer independently reran the companion
regression: 469 actions, 72 recaps, 43 with income. Finalization: pushed
(documentation only); the reviewer records verification of its resulting head on
...
Review State: PR #195 — Approved with follow-ups by /root/bundle_review for published code head c30930c905b2a6d3a9e43a2362fa96c207aa703d. Implementation actor: /root. Verdict: https://github.com/50thycal/party-games/pull/195#issuecomment-5745407389. No Blocking or Should-fix findings remain. Finalization: pushed (documentation only); reviewer verification of the resulting head is recorded on the PR. Browser/device acceptance remains the follow-up.
...
Next Step: Owner phone/iPad acceptance of the delivered second bundle; continue remaining YMIF design notes after this bundle.
...
Related PRs: [#190](https://github.com/50thycal/party-games/pull/190); #189 merged.
Review State:

| PR | Verdict | Reviewed head | Finalization |
|---|---|---|---|
| #190 | Approved with follow-ups | f8c7797f6a28a8bdb4193777f348cdd2e70b3d7e | pushed; final-head verification recorded separately on PR |

Independent reviewer: /root/engineering_art_review. Implementation actor: /root.
No unresolved Blocking/Should-fix findings. No merge performed.
Next Step: None for Engineering-art implementation. Hands-on phone/tablet card
acceptance remains parked; browser access was blocked.
...
Related PRs: [#189](https://github.com/50thycal/party-games/pull/189).
Validation: production build, lint, full Subway suite and latest-source focused SSR
checks passed. Original archive SHA matches upload. Browser localhost access
returned ERR_BLOCKED_BY_CLIENT; Vercel connector inspection unavailable. GitHub
Vercel deployment check is separately visible on PR. No physical-device acceptance claimed.
Review State: PR #189 Approved with follow-ups at source ffa198e949dffe4ba8a99917beeb8ed2ac72533c by /root/bend_review; implementation /root. No unresolved Blocking/Should-fix findings. Finalization: pushed; final-head verification follows separately on PR.
Next Step: None for QNHT UI implementation. Device acceptance, card-face planning
and end-trigger clarification are parked. No merge performed.
...
Implementation State: copy changes implemented and independently approved. Gameplay, card values, schema and internal compatibility IDs unchanged. Copy in fingerprint inputs changes the rules fingerprint; historical exports remain untouched.
Validation: production build, lint and full Subway suite passed, including card/score labels, phone progress, 36 complete games, exact replays and UI/API checks. No interactive preview-device test of this copy update.
Review State: PR #188 prior source 0dc366aa75ea26c7674ab50d50952819268441fc and final 308fc8cc5d2baca738ed023e04ad17f6f29ec725 were approved by /root/bend_review. Expanded source Approved at 3ddda3bbf281191e9cde963468dc4818ec266903 by /root/bend_review; implementation actor /root. No unresolved Blocking/Should-fix findings. Finalization pushed; final-head verification recorded separately on PR.
Next Step: None for terminology continuation. Owner review of draft rulebook remains parked. No merge performed.
...
Validation: production build, lint and full Subway suite passed. Six experimental two/three/four-player games replay exactly; independent focused compile/test also passed latest delayed completion/Undo fixture. API persistence/rejoin and SSR physical-leg/worksite/phone/setup checks passed. Vercel source preview successful. Browser/device validation unavailable due browser access restriction.
...
Review State: PR #187 Approved with follow-ups at source fc9f01ee1e7df0f8f5e49ef9825b5fbd50462c3c by /root/bend_review; implementation actor /root. No unresolved Blocking/Should-fix findings. Finalization: pushed; resulting head verification recorded separately on PR. Follow-ups are hands-on phone/iPad and experiment balance playtests.
Next Step: None for optional-bend implementation. No merge performed.
...
Owner authorized the recommendations after reporting a four-hour full run.
Scope/acceptance: speed continuation in the [approved spec](../build-specs/WS-005-card-audit.md).
Framework preflight checked canonical v0.12 on 2026-09-13; matches adopted version.
No new mission. Preserve seeds, policies, full card/count coverage, ordered saved
pairs, replay integrity and statistical caveats. Quick Check defaults to 25 trials;
...
board. Framework v0.12 was checked against canonical on 2026-09-13 and matches.
...
Goal, non-goals and acceptance: [approved Build Card/spec](../build-specs/WS-005-gzzf-playtest.md).
Canonical VERSION.md checked on 2026-09-13: v0.12 matches adoption. Existing WS-005
continues; no mission is added to the legacy over-limit board.
Implementation State: policy v2, state v21 starter occupancy, report provenance/
explanations and segment chips implemented. Current economy retained. Production
...
Implementation State: PR #177 implements all four interaction/export fixes and archives the complete supplied PRWK content as a normalized chat transcription, with separate observations/analysis and unverified legacy provenance. Build/lint, full Subway suite, MD share and bot recovery checks passed. Browser preview returned ERR_BLOCKED_BY_CLIENT; no physical iOS or visual acceptance claimed. No economy changes. On merge, this correction is implemented.
Review State: PR #177 Approved with follow-ups at reviewed source head 0a279e5966b6f0294b0ea3a7937499625bc200b4 by /root/feedback_review, implementation actor /root. Verdict: https://github.com/50thycal/party-games/pull/177#issuecomment-5650060467. No Blocking/Should-fix findings remain. Finalization: pushed; final-head review also checks the earlier PROJECT_MODEL highlight paragraph correction. No merge performed.
Next Step: owner phone/iPad and Save to Files acceptance after merge; review the existing portfolio balance question using further playtests.
...
start, without creating extra companies; construction remains iPad-only.
Root cause: code-only joins allocate remote seats, while managed-seat controller
access requires an undiscoverable recovery key. Fix the existing join flow, not
game rules or production room authority. Mixed labs explicitly select testing phone
