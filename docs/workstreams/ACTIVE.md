...
**Updated:** 2026-09-12 · **Build OS v0.12**

| ID | Workstream | Phase | Status | Current Next Step | Related PR |
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Larger 6/10/16-hole neighborhoods and 5/3/2 VP implemented; build/lint/simulations passed; PR #173 awaits independent review and visual acceptance | [#173](https://github.com/50thycal/party-games/pull/173) (open); #172 merged |
