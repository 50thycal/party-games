...
| [WS-004](WS-004-subway-tabletop-console.md) | Subway tabletop console and playtest clarity | READY_TO_BUILD | Active | Claude implements the approved tabletop console on the Design Handoff PR; card expansion awaits owner review | [#147](https://github.com/50thycal/party-games/pull/147) (draft Design Handoff) |
