...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | None for PR #185 implementation; broader device/balance playtest remains | [#185](https://github.com/50thycal/party-games/pull/185) (complete on merge); #184 merged |
...
- PARK — JNCG highlight privacy and bendable segments await sequential owner review; status/payment/draft bundle is complete on merge of PR #185.
