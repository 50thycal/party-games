...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | BUILDING | Active | Verify mechanics, balance simulations and browser playtests on branch | Branch `astra/subway-finished-edition` |
