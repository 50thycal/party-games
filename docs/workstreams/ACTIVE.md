...
| [WS-003](WS-003-subway-construction-access.md) | Subway construction access and route lookahead | READY_TO_BUILD | Blocked | Merge Build OS v0.5 adoption, rebase the Design Handoff PR, then implement | Design Handoff PR pending creation |
