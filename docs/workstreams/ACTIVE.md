...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | JNCG card/survey/label implementation complete on merge; owner confirms fresh-game playtest before next queued item | [#184](https://github.com/50thycal/party-games/pull/184) |
...
- PARK — Remaining JNCG feedback (draft row sizing, highlight privacy, player panels/notifications, public line/cluster display, toll/destination clarification and bendable segments) awaits sequential owner review after this approved card/survey/label build.
