...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Larger 6/10/16-hole neighborhoods and 5/3/2 VP implemented; build/lint/simulations passed; publishing review PR | [#172](https://github.com/50thycal/party-games/pull/172) (merged) |
