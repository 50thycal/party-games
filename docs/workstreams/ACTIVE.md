...
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Owner rules on peg-space measurement (audit G2/G3); independent review of rules audit PR | Rules audit PR open; [#197](https://github.com/50thycal/party-games/pull/197) paid extensions merged |
...
- Polished introduction delivered by merged #198.
