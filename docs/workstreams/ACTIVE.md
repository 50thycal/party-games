...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Undo, pan buffer and wider schedule validated; publish for independent review | [#166](https://github.com/50thycal/party-games/pull/166) (merged); codex/subway-undo-pan-space |
