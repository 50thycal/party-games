...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | BUILDING | Active | Validate public status/payment/no-stack/draft bundle and publish one PR | Branch `codex/subway-player-status-payments`; #184 merged |
...
- PARK — JNCG highlight privacy and bendable segments await sequential owner review; status/payment/draft items are admitted to the current implementation.
