...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Lab phone join correction implemented on merge; automated gates passed; owner phone/iPad acceptance and real-export calibration remain | [#176](https://github.com/50thycal/party-games/pull/176); #175 merged |
