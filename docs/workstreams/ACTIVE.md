...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | BUILDING | Active | Playtest Lab continuation: production iPad testing, shared bots, replay/comparison and repository archive; implementation validation in progress | [#174](https://github.com/50thycal/party-games/pull/174); #173 merged |
