...
| [WS-002](WS-002-subway-route-engineering.md) | Subway route engineering and playtest UX | REVIEW | Active | Merge the independently re-reviewed fix, then run the owner's balance playtest | [#141](https://github.com/50thycal/party-games/pull/141) (merged implementation); [#142](https://github.com/50thycal/party-games/pull/142) (fix, ready to merge) |
