...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Build-cost preview validated; independent current-head review and physical iPhone acceptance pending | [#164](https://github.com/50thycal/party-games/pull/164) (merged); [#165](https://github.com/50thycal/party-games/pull/165) (open) |
