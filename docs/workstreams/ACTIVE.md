...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Playtest Lab implemented on merge; automated gates passed; phone/iPad visual acceptance and real-export calibration remain | [#175](https://github.com/50thycal/party-games/pull/175); #174 merged |
