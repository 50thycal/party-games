...
| [WS-002](WS-002-subway-route-engineering.md) | Subway route engineering and playtest UX | REVIEW | Active | Re-review the no-op schedule Undo fix, then the owner's balance playtest | [#141](https://github.com/50thycal/party-games/pull/141) (merged implementation); [#142](https://github.com/50thycal/party-games/pull/142) (fix, ready for review) |
