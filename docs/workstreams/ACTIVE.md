...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Plan-panel viewport validated; independent current-head review pending | [#168](https://github.com/50thycal/party-games/pull/168) (merged); [#169](https://github.com/50thycal/party-games/pull/169) (open) |
