...
| [WS-004](WS-004-subway-tabletop-console.md) | Subway tabletop console and playtest clarity | BUILDING | Active | Claude builds the approved tabletop console, saved plans, Confirm placement, border starters, and public narration; card expansion awaits owner review | [#147](https://github.com/50thycal/party-games/pull/147) (draft Design Handoff) |
