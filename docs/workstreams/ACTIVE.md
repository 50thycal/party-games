...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Card Audit complete on merge; no further implementation step. Broader human balance/device acceptance remains | [#179](https://github.com/50thycal/party-games/pull/179); #178 merged |
