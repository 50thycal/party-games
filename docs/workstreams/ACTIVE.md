...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Tap-and-plan validated; publish for independent current-head review and physical iPhone acceptance | [#165](https://github.com/50thycal/party-games/pull/165) (merged); codex/subway-tap-and-plan |
