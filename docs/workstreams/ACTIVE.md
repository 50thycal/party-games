...
| [WS-004](WS-004-subway-tabletop-console.md) | Subway tabletop console and playtest clarity | REVIEW | Active | Independent review of the implementation PR, then land it on #147 and finalize there; card expansion awaits owner review of the audit | [#147](https://github.com/50thycal/party-games/pull/147) (Design Handoff), [#148](https://github.com/50thycal/party-games/pull/148) (implementation, stacks into #147) |
