...
**Updated:** 2026-09-11 · **Build OS v0.12**

| ID | Workstream | Phase | Status | Current Next Step | Related PR |
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Tap-and-plan validated; independent current-head review and physical iPhone acceptance pending | [#165](https://github.com/50thycal/party-games/pull/165) (merged); [#166](https://github.com/50thycal/party-games/pull/166) (open) |
