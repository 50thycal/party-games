...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | State v20 built and automated checks passed; publish transfer/objective PR and finish independent review | [#173](https://github.com/50thycal/party-games/pull/173) (merged) |
