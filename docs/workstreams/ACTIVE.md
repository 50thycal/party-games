...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Playtest guidance/tier/highlight changes implemented; publish final checks and review; neighborhood rules await owner discussion | [#171](https://github.com/50thycal/party-games/pull/171) (merged); new continuation pending publication |
