...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | PR #171 completion cash and companion automated gates passed; phone/iPad visual acceptance and independent current-head review pending | [#171](https://github.com/50thycal/party-games/pull/171) (open); #170 merged |
