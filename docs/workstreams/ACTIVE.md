...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Saved-plan opt-in validated; independent current-head review pending | [#167](https://github.com/50thycal/party-games/pull/167) (merged); [#168](https://github.com/50thycal/party-games/pull/168) (open) |
