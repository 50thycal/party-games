...
**Updated:** 2026-09-13 · **Build OS v0.12**

| ID | Workstream | Phase | Status | Current Next Step | Related PR |
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | GZZF corrections implemented on merge; fresh v21 phone/iPad acceptance and human balance remain (preview access blocked) | [#178](https://github.com/50thycal/party-games/pull/178); #177 previous continuation |
