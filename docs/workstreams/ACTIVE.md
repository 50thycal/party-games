...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | PR #170 state-v15 gates passed after Construction-card removal; phone/desktop visual verification and independent current-head review pending | [#170](https://github.com/50thycal/party-games/pull/170) (open); #169 merged |
