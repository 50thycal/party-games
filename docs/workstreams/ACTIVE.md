...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | Direct-piece fixes validated in phone/desktop browser; independent current-head review and physical iPhone acceptance pending | [#162](https://github.com/50thycal/party-games/pull/162) (merged); codex/subway-direct-piece-play |
