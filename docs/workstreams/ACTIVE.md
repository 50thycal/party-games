...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | BUILDING | Blocked | Saved planning implemented; accessible phone/desktop preview and independent review required | [#161](https://github.com/50thycal/party-games/pull/161) (merged); follow-up on codex/subway-saved-planning |
