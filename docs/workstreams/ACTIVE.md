...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | PR #172 neighborhoods implemented; build/lint/full simulations passed; independent review and phone/iPad visual acceptance pending | [#172](https://github.com/50thycal/party-games/pull/172) (open); #171 merged |
