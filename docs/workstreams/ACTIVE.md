...
|---|---|---|---|---|---|
| [WS-005](WS-005-subway-finished-edition.md) | Subway 2–4 player finished edition | REVIEW | Active | PR #172 automated gates passed; independent review and visual acceptance pending; neighborhood proposal awaits owner discussion | [#172](https://github.com/50thycal/party-games/pull/172) (open); #171 merged |
