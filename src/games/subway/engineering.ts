...
export const ENGINEERING_CARDS:EngineeringCard[] = [
  card('north-south','North–South Connection',3,'Line',['Single Line','Complete Line','Endpoints Only'],'Start one line on the north border and finish it on the south border, or vice versa. Intermediate nodes do not count.'),
  card('four-sides','Four-Side Service',4,'Line',['Company-wide','Endpoints Only'],'Have a starter or completed final peg on each of the four borders. Different sides need different nodes; lines need not connect.'),
  card('turning-corner','Turning the Corner',3,'Line',['Single Line','Complete Line','Endpoints Only'],'Start one line on an east/west border and finish on a north/south border, or vice versa.'),
  card('return-service','Return Service',3,'Line',['Single Line','Complete Line','Endpoints Only'],'Finish one line on the same border side as its starter.'),
  card('across-town','Across Town',5,'Line',['Connected Network','Endpoints Only'],'Connect qualifying endpoints on the east and west borders. Each may be a starter or a completed final peg, on the same or different lines.'),
  card('perimeter-service','Perimeter Service',5,'Line',['Single Line'],'One line has distinct nodes on at least three different border sides. Any nodes count; completion is not required.'),
  card('opposite-corners','Opposite Corners',6,'Line',['Connected Network','Endpoints Only'],'Connect qualifying endpoints in diagonally opposite corners. Each may be a starter or a completed final peg, on the same or different lines.'),
  card('transfer-station','Transfer Station',3,'Station',['Your Lines','One Neighborhood'],'Form a transfer between two of your lines inside one neighborhood.'),
  card('three-line-hub','Three-Line Hub',4,'Station',['Your Lines','One Station'],'Bring all three of your lines together in one station cluster, anywhere on the board.'),
  card('shared-stations','Shared Stations',4,'Station',['Opponent Contact','Distinct Stations'],'Participate in two separate station clusters containing your nodes and opponent nodes. The same opponent may join both. No neighborhood restriction.'),
  card('back-to-back','Back-to-Back Stations',4,'Station',['Single Line','Consecutive Nodes','Distinct Stations'],'Two consecutive nodes on one of your lines belong to two distinct transfers to your other lines. No neighborhood restriction.'),
  card('station-chain','Station Chain',5,'Station',['Connected Network','Distinct Stations'],'Have three distinct transfer stations between your lines in one connected company network. No neighborhood restriction.'),
  card('neighborhood-interchange','Neighborhood Interchange',5,'Station',['Your Lines','One Station'],'Form one station cluster spanning two touching neighborhoods, with nodes from at least two of your lines.'),
  card('terminal-interchanges','Terminal Interchanges',6,'Station',['Single Line','Complete Line','Distinct Stations'],'The starter and final peg of one completed line belong to two distinct transfers to your other lines.'),
  ...
  card('large-presence','Large Neighborhood Presence',2,'Neighborhood',['Company-wide','L'],'Place your nodes on three distinct holes in one large neighborhood. Any of your lines may contribute, connected or not.'),
  ...
  card('small-focus','Small Neighborhood Focus',5,'Neighborhood',['Single Line','S'],'Place two nodes of the same line on distinct holes in one small neighborhood. They need not be consecutive.'),
  card('neighborhood-stopover','Neighborhood Stopover',2,'Neighborhood',['Single Line','Consecutive Nodes'],'Place two consecutive nodes of one line inside the same neighborhood, of any size.'),
];
export const ENGINEERING_RULES:Record<string,string> = {
  'Single Line':'One line satisfies the whole card. Its connections to other lines are allowed, but their nodes cannot help.',
  ...
  'Endpoints Only':'A starter peg or the final peg of a completed line. An unfinished growing end does not count.',
  'Complete Line':'Every segment on the qualifying contract must be built.',
  'Consecutive Nodes':'Successive nodes on one line, joined by one segment.',
