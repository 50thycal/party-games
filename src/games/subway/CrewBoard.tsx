...
export function CrewBoard({game,viewerId,busy,veiled,act}:{game:SubwayState;viewerId:string;busy:boolean;veiled:boolean;act:(type:string,payload?:Record<string,unknown>)=>unknown}) {
  ...
  return <Printed style={{width:660, maxWidth:"100%"}} zone="schedule" title="Construction schedule" subtitle={`Round ${game.currentPeriod} / ${SUBWAY_CONFIG.timelinePeriods}`}>
    ...
    <div className="mt-6 border-t-2 border-stone-300 pt-4">
