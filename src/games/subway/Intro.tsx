...
export function introSlides({ bendMode = "delayed" }: Options): Slide[] {
  return [
    ...
    {kicker:"Read the distance",title:"Build the printed length.",text:"Every segment must match its printed length, within ±0.5 peg space.",note:"Measure the whole path, including both legs of a bend. Recipe totals always sum the printed numbers.",art:"length"},
