...
export default function SubwayHotseat() {
  ...
  return <main className="min-h-screen bg-[#10232d] p-2 text-white sm:p-3" style={{fontFamily:"ui-sans-serif, system-ui, sans-serif"}}>
    ...
    {help && <aside className="mb-2 rounded-xl bg-[#f5f3e9] p-4 text-sm leading-relaxed text-slate-900"><b>Your first journey</b><ol className="ml-5 mt-2 list-decimal space-y-1"><li>Draft one route at list price each turn. Everyone ends with three routes; there is no pass.</li><li>Receive one two-neighborhood and one three-neighborhood Destination at start. Draft three Engineering goals from two face-up choices or a blind draw.</li><li>Each round, hire crews for different routes: $1M / $3M / $6M for 1 / 2 / 3 crews. Build one segment per crew. Start with $40M; construction lasts at most nine rounds. Buy one extra Destination for $5M before hiring, once per game.</li><li>Place your free starter pegs on the border. Follow each route’s printed segment lengths; turns may be up to 90°.</li><li>Tap a glowing peg, inspect the next step and toll, then Confirm. You can plan ahead without committing.</li><li>Score finished routes, connected missions and Engineering goals. Longest continuous network earns 5 VP (3 each if tied). Keep debt low. Most points wins!</li></ol><p className="mt-2">Use Board, Schedule, Lines and Cards to move around the table. Drag to pan; scroll or pinch to zoom. Pass the device before revealing the next company’s cards. Different company lines transfer at horizontally/vertically adjacent nodes; one peg per hole. Joining an opponent station costs $1M once for that line at that station. Every new crossing still costs $1M. North is top, south bottom, west left and east right.</p></aside>}
